...
<head>
    ...
    <title>Teste Handix API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-contacts">
                                <a href="#endpoints-GETapi-v1-contacts">GET api/v1/contacts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-contacts">
                                <a href="#endpoints-POSTapi-v1-contacts">POST api/v1/contacts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-contacts--id-">
                                <a href="#endpoints-GETapi-v1-contacts--id-">GET api/v1/contacts/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-contacts--id-">
                                <a href="#endpoints-PUTapi-v1-contacts--id-">PUT api/v1/contacts/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-contacts--id-">
                                <a href="#endpoints-DELETEapi-v1-contacts--id-">DELETE api/v1/contacts/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-v1-contacts">GET api/v1/contacts</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-contacts">POST api/v1/contacts</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-v1-contacts"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-contacts--id-">GET api/v1/contacts/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/contacts/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/contacts/architecto"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-contacts--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the contact. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-contacts--id-">PUT api/v1/contacts/{id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-contacts--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the contact. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="PUTapi-v1-contacts--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-contacts--id-">DELETE api/v1/contacts/{id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-contacts--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the contact. Example: <code>architecto</code></p>
